...
func (mq *MemberQuery) QueryOrders() *OrderQuery {
...
func (mq *MemberQuery) WithOrders(opts ...func(*OrderQuery)) *MemberQuery {
	query := &OrderQuery{config: mq.config}
...
func (mq *MemberQuery) sqlAll(ctx context.Context) ([]*Member, error) {
	...
	if query := mq.withOrders; query != nil {
		...
		query.Where(predicate.Order(func(s *sql.Selector) {
			s.Where(sql.InValues(member.OrdersColumn, fks...))
		}))
