...
func HasDelivery() predicate.Order {
	return predicate.Order(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(DeliveryTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2O, true, DeliveryTable, DeliveryColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasDeliveryWith(preds ...predicate.Delivery) predicate.Order {
	return predicate.Order(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
