...
func OrderPrice(v int32) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldOrderPrice), v))
	})
}

// Count applies equality check predicate on the "count" field. It's identical to CountEQ.
func Count(v int32) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
...
func OrderPriceEQ(v int32) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldOrderPrice), v))
	})
}
...
func OrderPriceNEQ(v int32) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldOrderPrice), v))
	})
}

// OrderPriceIn applies the In predicate on the "orderPrice" field.
func OrderPriceIn(vs ...int32) predicate.OrderItem {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.OrderItem(func(s *sql.Selector) {
		...
		s.Where(sql.In(s.C(FieldOrderPrice), v...))
	})
}

// OrderPriceNotIn applies the NotIn predicate on the "orderPrice" field.
func OrderPriceNotIn(vs ...int32) predicate.OrderItem {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.OrderItem(func(s *sql.Selector) {
		...
		s.Where(sql.NotIn(s.C(FieldOrderPrice), v...))
	})
}

// OrderPriceGT applies the GT predicate on the "orderPrice" field.
func OrderPriceGT(v int32) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		s.Where(sql.GT(s.C(FieldOrderPrice), v))
	})
}

// OrderPriceGTE applies the GTE predicate on the "orderPrice" field.
func OrderPriceGTE(v int32) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		s.Where(sql.GTE(s.C(FieldOrderPrice), v))
	})
}

// OrderPriceLT applies the LT predicate on the "orderPrice" field.
func OrderPriceLT(v int32) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		s.Where(sql.LT(s.C(FieldOrderPrice), v))
	})
}

// OrderPriceLTE applies the LTE predicate on the "orderPrice" field.
func OrderPriceLTE(v int32) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		s.Where(sql.LTE(s.C(FieldOrderPrice), v))
	})
}

// CountEQ applies the EQ predicate on the "count" field.
func CountEQ(v int32) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCount), v))
	})
}
...
func CountNEQ(v int32) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
...
func CountIn(vs ...int32) predicate.OrderItem {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CountNotIn(vs ...int32) predicate.OrderItem {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CountGT(v int32) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
...
func CountGTE(v int32) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
...
func CountLT(v int32) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
...
func CountLTE(v int32) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
